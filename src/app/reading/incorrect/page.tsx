...
import { READING_PART_3 } from "../../../utils/part2";

export default function ReadingIncorrectAnswersPage() {
  const [incorrectAnswers, setIncorrectAnswers] = useState<ReadingIncorrectAnswer[]>([]);
  const [selectedPart, setSelectedPart] = useState<'all' | 'reading_part1' | 'reading_part2' | 'reading_part3'>('all');
  ...
  function handleClearAll() {
    if (confirm('Are you sure you want to clear all reading incorrect answers?')) {
      clearAllReadingIncorrectAnswers();
      loadIncorrectAnswers();
    }
  }

  function handleClearByPart(part: 'reading_part1' | 'reading_part2' | 'reading_part3') {
    if (confirm(`Are you sure you want to clear all incorrect answers for ${part.replace('_', ' ').toUpperCase()}?`)) {
  ...
  function handlePracticeSubmit() {
    ...
    if (currentQuestion.part === 'reading_part1') {
      ...
      isCorrect = JSON.stringify(practiceAnswers.sentenceOrder) === JSON.stringify(currentQuestion.correctAnswer);
  ...
  const getFullQuestionData = (question: ReadingIncorrectAnswer) => {
    if (question.part === 'reading_part1') {
      ...
      return READING_PART_3.find((q: any) => q.group.toString() === question.id);
    }
    return null;
  };
          ...
          <>
            ...
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              ...
              <p style={{ 
                ...
                Review and practice your incorrect reading answers to improve your performance
              </p>
            </div>
            ...
            <div style={{ 
              ...
              <div 
                className={`filter-card ${selectedPart === 'reading_part1' ? 'active' : ''}`}
              ...
              >
                <h3 style={{ color: "inherit", margin: "0 0 8px 0" }}>📖 Reading Part 1</h3>
                <p style={{ fontSize: "24px", fontWeight: "bold", color: "inherit", margin: 0 }}>
              ...
              <div 
                className={`filter-card ${selectedPart === 'reading_part2' ? 'active' : ''}`}
              ...
              >
                <h3 style={{ color: "inherit", margin: "0 0 8px 0" }}>🔄 Reading Part 2</h3>
                <p style={{ fontSize: "24px", fontWeight: "bold", color: "inherit", margin: 0 }}>
              ...
              <div 
                className={`filter-card ${selectedPart === 'reading_part3' ? 'active' : ''}`}
              ...
              >
                <h3 style={{ color: "inherit", margin: "0 0 8px 0" }}>🏷️ Reading Part 3</h3>
                <p style={{ fontSize: "24px", fontWeight: "bold", color: "inherit", margin: 0 }}>
            ...
            <div className="card" style={{ marginBottom: "30px", textAlign: "center" }}>
              ...
              <div style={{ 
                ...
                <Link href="/reading/part3" className="btn btn-secondary">
                  🏷️ Reading Part 3
                </Link>
              ...
              <div className="card" style={{ textAlign: "center", padding: "60px 20px" }}>
                ...
                <p style={{ color: "var(--card-text)", fontSize: "18px", margin: "0 0 20px 0" }}>
                  {selectedPart === 'all' 
                    ...
                    : `You have no incorrect answers in ${selectedPart.replace('_', ' ').toUpperCase()}!`
                  }
                </p>
                    ...
                    <div style={{ 
                      ...
                      <div>
                        <h4 style={{ 
                          ...
                          {item.part === 'reading_part1' ? '📖' : item.part === 'reading_part2' ? '🔄' : '🏷️'} {item.part.replace('_', ' ').toUpperCase()} - {item.id}
                        </h4>
                        <p style={{ 
                          color: "var(--card-text)", 
                          margin: "0 0 12px 0",
                      ...
                      <Link 
                        href={`/reading/${item.part.replace('reading_', '')}${item.part === 'reading_part1' ? '' : `?${item.part === 'reading_part2' ? 'exercise' : 'group'}=${item.id}`}`}
                      ...
                      {item.part === 'reading_part1' && item.questionData && (
                        <div>
                          <p style={{ 
                            ...
                            <strong>Question:</strong> {item.questionData.questionStart} <strong>_____</strong> {item.questionData.questionEnd}
                          </p>
                          <p style={{ 
                            color: "#dc2626", 
                            margin: "0 0 8px 0",
                      ...
                      {item.part === 'reading_part3' && (
                        <div>
                          ...
                          <p style={{ 
                            ...
                            <strong>Result:</strong> Incorrect heading assignments
                          </p>
                        </div>
                      )}
                    </div>
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                <span style={{ 
                  ...
                  Question {currentQuestionIndex + 1} of {incorrectAnswers.length}
                </span>
                <button 
            ...
            {currentQuestion && (
              <div className="card">
                <h3 style={{ 
                  ...
                  {currentQuestion.part === 'reading_part1' ? '📖' : currentQuestion.part === 'reading_part2' ? '🔄' : '🏷️'} {currentQuestion.part.replace('_', ' ').toUpperCase()} - {currentQuestion.id}
                </h3>
                ...
                <div style={{ 
                  ...
                  <p style={{ 
                    ...
                    Practice functionality can be implemented here for each reading part type.
                    <br />
                    <Link 
                      href={`/reading/${currentQuestion.part.replace('reading_', '')}${currentQuestion.part === 'reading_part1' ? '' : `?${currentQuestion.part === 'reading_part2' ? 'exercise' : 'group'}=${currentQuestion.id}`}`}
                      className="btn btn-primary"
