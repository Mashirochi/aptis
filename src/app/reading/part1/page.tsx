...
const ALL_QUESTION_SETS = [
  ...
  { name: "Questions 96-100", questions: questions1_20 },
  { name: "Questions 101-105", questions: questions1_21 },
...
function ReadingPart1Content() {
  ...
  const [viewMode, setViewMode] = useState<"full" | "parts">(
    mode as "full" | "parts"
  );
  ...
  const currentQuestions: Question[] =
    viewMode === "full"
      ? ALL_QUESTIONS
      : ALL_QUESTION_SETS[currentSet].questions.map(
          (q: BaseQuestion, index: number) => ({
            ...q,
    ...
    return (
      <div key={questionId} className="card" style={{ marginBottom: 20 }}>
        <div style={{ marginBottom: 16 }}>
          ...
          >
            <strong>{index + 1}.</strong> {question.questionStart}{" "}
            <strong>_____</strong> {question.questionEnd}
          </p>
        </div>
          ...
          {question.answerOptions.map((option, optionIndex) => {
            ...
            return (
              <button
                ...
                onClick={() =>
                  !showAnswer &&
                  handleAnswerSelect(questionId, option, question)
                }
                disabled={showAnswer}
                className={className}
        ...
        <div className="card" style={{ marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            <button
              ...
              className={`btn ${
                viewMode === "full" ? "btn-primary" : "btn-secondary"
              }`}
            >
            ...
            <button
              ...
              className={`btn ${
                viewMode === "parts" ? "btn-primary" : "btn-secondary"
              }`}
            >
            ...
            <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
              {ALL_QUESTION_SETS.map((set, index) => (
                <button
                  ...
                  className={`btn ${
                    currentSet === index ? "btn-primary" : "btn-secondary"
                  }`}
                  style={{ fontSize: "14px" }}
                >
                  {set.name}
            ...
            {viewMode === "parts" && (
              <>
                ...
                <button
                  onClick={() =>
                    setCurrentSet(
                      Math.min(ALL_QUESTION_SETS.length - 1, currentSet + 1)
                    )
                  }
        ...
        <div className="card" style={{ marginTop: 20 }}>
          ...
          >
            ...
            >
              ...
              >
                {
                  Object.values(answeredQuestions).filter(
                    (val) => val === false
                  ).length
                }
              </div>
