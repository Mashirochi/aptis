...
export const READING_PART_3 = [
  {
    ...
    data: [
      {
        key: 1,
        option: "The custom of coffee drinking begins to spread",
        paragraph:
      ...
      {
        key: 3,
        option: "A habit that has become a big economy",
        paragraph:
      ...
      {
        key: 4,
        option: "Problems of coffee economy",
        paragraph:
      ...
      {
        key: 5,
        option: "A remedy of unjust revenue distribution",
        paragraph:
      ...
      {
        key: 6,
        option: "Health risks versus health benefits debate",
        paragraph:
      ...
      {
        key: 7,
        option: "The ancient origin of coffee",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "Symbol of privilege and wealth",
        paragraph:
      ...
      {
        key: 2,
        option: "Opening the door for everyone",
        paragraph:
          "It wasnâ€™t until the reign of Englandâ€™s King John, in the early 13th century, that the concept of the zoo shifted dramatically. King John, a progressive ruler, opened the royal animal exhibit at the Tower of London to the public. This groundbreaking decision marked a turning point, as zoos gradually transitioned from being exclusive enclaves of royalty to inclusive spaces accessible to people from all walks of life. Zoos transformed into places where the general public could enjoy leisure and explore the wonders of the animal kingdom.",
      },
      {
        key: 3,
        option: "Away from amusement towards instruction",
        paragraph:
      ...
      {
        key: 6,
        option: "A new mission of conversation",
        paragraph:
          "As climate change and habitat destruction pose significant threats to wildlife, zoos have embraced a new mission â€“ protecting animals on the brink of extinction. They play a crucial role in species recovery and act as sanctuaries for critically endangered creatures. Through dedicated conservation programs, zoos work tirelessly to ensure the survival and well-being of these vulnerable species. By taking a lead in conservation efforts, zoos aim to inspire visitors and the wider community to recognize the urgency of protecting our fragile ecosystems and the species that inhabit them.",
      },
      {
        key: 7,
        option: "A modern day alternative",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "Making things last longer",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "An alternative history of settlement",
        paragraph:
      ...
      {
        key: 2,
        option: "Natural barrier to resettlement",
        paragraph:
      ...
      {
        key: 3,
        option: "Technology helps uncover the ocean's secret",
        paragraph:
      ...
      {
        key: 4,
        option: "A Journey made by stages",
        paragraph:
      ...
      {
        key: 5,
        option: "A new evidence that leads to speculation",
        paragraph:
  ...
  },
  {
    ...
    data: [
      ...
      {
        key: 2,
        option: "Difficulties for modern readers",
        paragraph:
      ...
      {
        key: 3,
        option: "Keeping the readers guessing",
        paragraph:
      ...
      {
        key: 4,
        option: "The influence of media",
        paragraph:
          "Dickens's legacy is undeniable. His works have been translated and used in over 100 countries and are studied by most schoolchildren in the world. It has even been said that Dickensâ€™ legacy belongs not to one era but to all times. It is easy to see that Dickens lives on in society and culture through his language and through his enduring influence on education and the media.",
      },
      {
        key: 5,
        option: "Dickens's early success",
        paragraph:
      ...
      {
        key: 6,
        option: "Trying to protect his property",
        paragraph:
      ...
      {
        key: 7,
        option: "Bring the books to life",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "The economy during the Golden Age",
        paragraph:
      ...
      {
        key: 4,
        option: "Different types of tulip",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "The origins of chinese food",
        paragraph:
      ...
      {
        key: 2,
        option: "The influence of philosophy",
        paragraph:
      ...
      {
        key: 6,
        option: "Changes in the Chinese diets",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "Factors contributing to inactivity",
        paragraph:
      ...
      {
        key: 2,
        option: "The situation have the potential of being worst",
        paragraph:
      ...
      {
        key: 3,
        option: "The success of a simple idea",
        paragraph:
      ...
      {
        key: 4,
        option: "The wider effects of regular activity",
        paragraph:
      ...
      {
        key: 5,
        option: "Ways in which environment can influence behavior",
        paragraph:
      ...
      {
        key: 6,
        option: "A design for exercise and for study",
        paragraph:
      ...
      {
        key: 7,
        option: "Achieving the right balance",
        paragraph:
  ...
  },
  {
    ...
    data: [
      ...
      {
        key: 3,
        option: "Where is the end of the Earth?",
        paragraph:
      ...
      {
        key: 4,
        option: "Hidden geography",
        paragraph:
          "Beneath the massive ice sheets lies a concealed landscape that reveals much about the planetâ€™s geological history. This region hosts the largest ice mass globally, covering approximately 98 percent of its area. The ice conceals a variety of geological features, including mountains and valleys. Researchers analyze ice cores extracted from deep within the layers to uncover details about past climates and atmospheric conditions. These investigations provide vital information for understanding global climate change and its potential implications for our world.",
      },
      {
        key: 5,
        option: "Race to the Pole",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "The easiest way to travel",
        paragraph:
      ...
      {
        key: 2,
        option: "Result of a lucky escape",
        paragraph:
          "A popular story suggests that Doggett was saved by a waterman after falling into the Thames in 1715. To show his gratitude, he organized a race for six young watermen, offering a prize for the fastest rower on a 7.4-km course between two pubs named â€œThe Swanâ€ in London Bridge and Chelsea.",
      },
      {
        key: 3,
        option: "Origins of what the winner receives",
        paragraph:
          "Unlike typical prizes, Doggett awarded a traditional red waterman's coat with a silver badge inscribed with â€œLiberty.â€ This badge commemorated the coronation of George I of the House of Hanover on August 1, 1714. Doggett chose August 1 for the annual race to honor this event. The badge today still includes â€œLibertyâ€ and an image of the Hanover horse. Doggett managed the race and financed it himself until his death in 1721.",
      },
      {
        key: 4,
        option: "A need for change",
        paragraph:
  ...
  },
  {
    ...
    data: [
      ...
      {
        key: 4,
        option: "Factory farming is harmful",
        paragraph:
      ...
      {
        key: 6,
        option: "Health gets better with diet",
        paragraph:
      ...
      {
        key: 7,
        option: "Our responsibilities with global",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "A physically demanding activity",
        paragraph:
      ...
      {
        key: 2,
        option: "A good way to boost your memory",
        paragraph:
      ...
      {
        key: 3,
        option: "A great opportunity to broaden your social circle",
        paragraph:
          "Playing an instrument isnâ€™t only good for your brain, itâ€™s also a fantastic opportunity to connect with other like-minded individuals. Joining a band, orchestra, or music group allows musicians to collaborate, share experiences, and develop friendships. Music also has a universal language, making it easier to communicate and connect with people from diverse backgrounds and cultures.",
      },
      {
        key: 4,
        option: "A way to learn discipline and the importance of routine",
        paragraph:
          "Unless youâ€™re an out-of-this-world child prodigy, learning to play an instrument isnâ€™t a skill you can master overnight. Learning music takes time and effort, and helps children understand that if they want to be good at something, theyâ€™ll need to put in the hours and organize their time effectively.This disciplined approach fosters a strong work ethic, patience, and perseverance that can be applied to other areas of life.",
      },
      {
        key: 5,
        option: "A creative outlet for expressing emotions",
        paragraph:
      ...
      {
        key: 6,
        option: "Enhanced sensitivity to other people's feelings",
        paragraph:
      ...
      {
        key: 7,
        option: "Develop a greater sense of well-being",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "A sensible financial choice",
        paragraph:
      ...
      {
        key: 2,
        option: "The price of convenience may be high",
        paragraph:
      ...
      {
        key: 3,
        option: "The importance of planning in advance",
        paragraph:
          "Moving to a hotel for an extended period requires careful planning and preparation. Itâ€™s not a decision that can be made overnight. Individuals need to consider what belongings to bring, how to transport them, and how to organize their new living space. It's important to prioritize essential items and leave behind what is not necessary. By planning ahead, individuals can ensure a smooth transition to hotel living, avoiding unnecessary stress and disruptions.",
      },
      {
        key: 4,
        option: "The impact of lack of freedom",
        paragraph:
      ...
      {
        key: 5,
        option: "The benefits of living with less",
        paragraph:
      ...
      {
        key: 6,
        option: "The advantages of having your own space",
        paragraph:
  ...
  },
  {
    ...
    data: [
      {
        key: 1,
        option: "Changing the definition of mountain",
        paragraph:
      ...
      {
        key: 2,
        option: "The unique feeling of achievement",
        paragraph:
      ...
      {
        key: 3,
        option: "Publicity of achievement",
        paragraph:
      ...
      {
        key: 4,
        option: "The mistake of misplaced priorities",
        paragraph:
